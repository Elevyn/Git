...
public class KalkukidzAreaCuadrado extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					KalkukidzAreaCuadrado frame = new KalkukidzAreaCuadrado();
	 ...
	 * Create the frame.
	 */
	public KalkukidzAreaCuadrado() {
		setResizable(false);
		setTitle("KALKUKIDZ Area Cuadrado");
		...
		textlado.setBounds(177, 190, 86, 20);
		contentPane.add(textlado);
		textlado.setColumns(10);
		
		lblCirculo = new JLabel("");
		lblCirculo.setIcon(new ImageIcon(KalkukidzAreaCuadrado.class.getResource("/iconos/cuadrado.png")));
		lblCirculo.setBackground(new Color(154, 205, 50));
		lblCirculo.setBounds(273, 126, 152, 151);
		contentPane.add(lblCirculo);
		
		b7 = new JButton("7");
		b7.addActionListener(this);
		b7.setFont(new Font("Arial", Font.PLAIN, 18));
		b7.setBackground(new Color(255, 228, 225));
		...
		b8.setBackground(new Color(255, 228, 225));
		...
		b9.setBackground(new Color(255, 228, 225));
		...
		b4.setBackground(new Color(255, 228, 225));
		...
		b5.setBackground(new Color(255, 228, 225));
		...
		b6.setBackground(new Color(255, 228, 225));
		...
		bComa.setBackground(new Color(255, 228, 225));
		...
		b0.setBackground(new Color(255, 228, 225));
	...
	public void actionPerformed(ActionEvent e) {
		...
		//Realizamos la operación
			...
			resultado = ladoNum*ladoNum;
			operacion = ladoNum + "X" + ladoNum + "=" + resultado;
