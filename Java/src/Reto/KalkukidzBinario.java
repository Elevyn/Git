...
public class KalkukidzBinario extends JFrame implements ActionListener {
	...
	public KalkukidzBinario() {
		...
		btnCero.setBounds(10, 180, 187, 158);
		...
		btnUno.setBounds(10, 11, 187, 158);
		...
		btnOk.setBounds(218, 217, 90, 127);
		...
		btnCe.setBounds(310, 217, 90, 127);
		panel_botones.add(btnCe);
		
		btnAnd = new JButton("AND");
		btnAnd.setBounds(218, 111, 187, 97);
		...
		lblOperacionesRealizadas.setBounds(0, 0, 420, 48);
